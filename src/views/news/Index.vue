 ...
 * @LastEditTime: 2021-02-22 13:49:20
 * @Descripttion:
-->
  ...
  <div class="main">
        ...
        <a-col :span="22">
          <a-form-model layout="inline" :model="formInline" @submit="handleSubmit" @submit.native.prevent>
            <a-form-model-item label="发送人">
              <a-input v-model="站点名称" placeholder="请输入发送人姓名" />
            </a-form-model-item>
            <a-form-model-item label="接收人">
              <a-input v-model="站点名称" placeholder="请输入接收人姓名" />
            </a-form-model-item>
          </a-form-model>
        </a-col>
        <a-col :span="2">
    ...
    <div class="pic-list">
      ...
      <a-table
        ...
        <a-table-column key="headImage" title="发送人" data-index="headImage" :width="75" align="center">
          <template slot-scope="headImage">
            <span style="padding-left:20px">{{headImage}}</span>
          </template>
        </a-table-column>
        <a-table-column key="headImage" title="接收人" data-index="headImage" :width="75" align="center">
          <template slot-scope="headImage">
            <span style="padding-left:20px">{{headImage}}</span>
          </template>
        </a-table-column>
        ...
        <a-table-column key="bindStatus" title="消息内容" data-index="bindStatus" :width="110">
