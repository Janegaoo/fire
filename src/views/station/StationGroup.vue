 ...
 * @LastEditTime: 2021-02-22 13:25:36
 * @Descripttion:
-->
...
<template>
  <div class="main">
    ...
    <div class="pic-list">
      <a-row>
        <a-col :span="12" class="left">站组管理</a-col>
      ...
      <a-table
        ...
        <a-table-column key="headImage" title="站组名称" data-index="headImage" :width="75" align="center">
        ...
        <a-table-column key="bindStatus" title="联系人电话" data-index="bindStatus" :width="110">
        ...
        <a-table-column key="packageName" title="消防站数量" data-index="packageName" :width="110">
