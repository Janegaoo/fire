 ...
 * @LastEditTime: 2021-02-22 13:26:59
 * @Descripttion:
-->
<template>
  <div>
    <a-modal
      :title="companyId ? '站组详情' : '编辑站点'"
      :visible="visible"
    ...
    >
      ...
      >
        <a-form-model-item label="站组名称" prop="companyName" placeholder="请输入站组名称">
          <a-input v-model="form.companyName" />
        </a-form-model-item>
        <a-form-model-item label="地址" prop="companyName" placeholder="请输入站点地址">
          <a-input v-model="form.companyName" />
        </a-form-model-item>
        <a-form-model-item label="联系人" prop="companyName" placeholder="请输入站点联系人名称">
          <a-input v-model="form.companyName" />
        </a-form-model-item>
        <a-form-model-item label="联系电话" prop="companyName" placeholder="请输入联系人电话">
          <a-input v-model="form.companyName" />
        </a-form-model-item>
        <a-form-model-item label="站点" prop="comments" placeholder="请输入备注信息">
